...
server.tool('research-topic', 'Research a topic and return informational summary (LOW RISK - typically ALLOWED)', {
...
server.tool('retry-workflow', 'Retry a failing workflow (MEDIUM RISK - may DEFER if loop threshold exceeded)', {
    ...
    return guardedToolHandler('retry-workflow', `Retry workflow ${workflowId} (attempt ${retryCount + 1})`, ['loop'], async () => {
